...
RUN wget -O /data/ghproxy/config.yaml https://raw.githubusercontent.com/WJQSERVER-STUDIO/ghproxy-go/main/config/config.yaml
RUN wget -O /data/www/index.html https://raw.githubusercontent.com/WJQSERVER-STUDIO/ghproxy-go/main/pages/index.html
RUN wget -O /data/www/favicon.ico https://raw.githubusercontent.com/WJQSERVER-STUDIO/ghproxy-go/main/pages/favicon.ico
...
RUN VERSION=$(curl -s https://raw.githubusercontent.com/WJQSERVER-STUDIO/ghproxy-go/main/VERSION) && \
    wget -O /data/ghproxy/ghproxy https://github.com/WJQSERVER-STUDIO/ghproxy-go/releases/download/$VERSION/ghproxy
